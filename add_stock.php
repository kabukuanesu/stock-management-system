...
<?php require ('header2.php'); ?>
    ...
    <div class="row text-center" style="padding: 20px;margin: 20px;margin-left: 350px;margin-right: 350px;">
        ...
        <div class="col"
            ...
            <form action='stocking.php' method="POST" enctype="multipart/form-data">
                <h2 style="border-radius: 20px 20px 0px 0px;background-color: #0b4c61;color: white;padding: 10px;"> ADD STOCK <i class="material-icons">control_point_duplicate</i></h2>
                <label style="font-size: 20px; margin-left: 3px;"><b>Name*</b></label>
                <br>
                ...
                <input type="text" id="description" name='description'
                    style="font-size: 20px;margin-top:10px;margin-bottom:10px;" required>
                <br>
                <label style="font-size: 20px;"><b>Supplier*</b></label>
                <br>
                ...
                <input type="number" id="quantity" name='quantity'
                    style="font-size: 20px;margin-top:10px;margin-bottom:10px;" required>
                <br>
                <label style="font-size: 20px;"><b>Cost Price*</b></label>
                <br>
